...
\begin{itemize}
  \item[] \texttt{C/C++}, Fortran, Python, Julia, Rust, Lua, Kokkos, MPI, OpenMP
\end{itemize}
\item[] Software \& Numerical Instruments
\begin{itemize}
        \item[] \textsc{Phoebus}, \textsc{Parthenon}, \textsc{Flash}, \textsc{Athena}, \textsc{Thornado}, \textsc{Flash-X}, \textsc{Snec}, \textsc{Mesa}
\end{itemize}
\end{genericlist}
