...
\href{astrobarker.dev}{\texttt{astrobarker.dev}}\\
...
\begin{chronlist}
\item[2019--2024] Michigan State University. \\ 
        Dual PhD, Astronomy and Astrophysics \& 
 Computational Mathematics, Science, and Engineering.

\item[2014--2019] The University of Tennessee, Knoxville.  \\
  Bachelor of Science, \\
  Honors in physics, second major in mathematics,
...
\begin{chronlist}
\item[2026--Present] Software Engineer, Flatiron Institute, Center for Computational Astrophysics
\item[2024--2026] Metropolis Postdoctoral Fellow, Los Alamos National Laboratory
...
\item ``ASTRAL: A Framework for Optimal Placement and Emulation of Stellar Evolution Models.'' T. Gravely, M. Risti\'c, \textbf{B. L. Barker}, 2026. Accepted to Physical Review D.

\item \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250903003R/abstract}{``Kilonovae and Long-duration Gamma-ray Bursts.''} M. Risti\'c, \textbf{B. L. Barker}, et al. 2026, The Astrophysical Journal, Volume 1002.
...
\sectionheader{Selected Open Source Software Projects}
\begin{genericlist}
...
\item \href{https://github.com/endeve/thornado}{\textsc{Thornado}} | Prior Developer | 
  High order neutrino radiation hydrodynamics for supernovae
...
\item ``From Light Curves to Physics: Inference and Modeling Challenges in Supernovae.'' University of Arizona Theoretical Astrophysics Program Colloquia. 2026.
...
\item ``The Journal of Open Source Software: Software Citation in Astronomy and Beyond.'' Software Citation Workshop. April 2026.

\item ``Phobeus: Phifty One Ergs Blows up a Star.'' Parthenon Developers Workshop. June 2025.
...
\begin{itemize}
  \item[] \texttt{C/C++}, Fortran, Python, Julia, Rust, Lua, Kokkos, MPI, OpenMP, bash
\end{itemize}
\item[] Developer Skills
\begin{itemize}
  \item[] Version control, containerization, continuous integration and deployment
\end{itemize}
\item[] Software \& Numerical Instruments
\begin{itemize}
        \item[] \textsc{Mesa}, \textsc{Phoebus}, \textsc{Parthenon}, \textsc{Flash}, \textsc{Athena}, \textsc{Thornado}, \textsc{Flash-X}, \textsc{Snec}
\end{itemize}
\end{genericlist}

\sectionheader{Advising and Mentoring}
\begin{genericlist}
\item[] Trevor Gravely, Vanderbilt University
\begin{itemize}
        \item[] LANL Research Mentor
  \begin{itemize}
          \item[] Open source software product, Astral
  \end{itemize}
\end{itemize}
\item[] Levi Webb, Michigan State University
\begin{itemize}
\item[] Undergraduate research mentor
\end{itemize}
\item[] Anita Agasaveeran, Michigan State University
\begin{itemize}
\item[] Undergraduate research mentor
\end{itemize}
\end{genericlist}
